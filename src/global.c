...
gchar * PACKAGE_GDR = NULL;
gchar * PACKAGE_SQD = NULL;
gchar * PACKAGE_BND = NULL;
gchar * PACKAGE_ANG = NULL;
gchar * PACKAGE_RIN = NULL;
gchar * PACKAGE_CHA = NULL;
gchar * PACKAGE_SPH = NULL;
gchar * PACKAGE_MSD = NULL;
